...
public class PlayerController implements Initializable {
    ...
    DecimalFormat one_digit = new DecimalFormat("#.0");
    ...
    private void handleReady() {
        ...
        lengthText.setText(one_digit.format(duration.toMillis()) + " ms");
    ...
    private void handleStop(ActionEvent event) {
        ...
        @FXML
    private void sliderIsPressed(Event event) {
        if (mediaPlayer != null) {
           mediaPlayer.pause(); 
        }  
    }
    ...
    @FXML
    private void sliderIsReleased(Event event) {
        if (mediaPlayer != null) {
